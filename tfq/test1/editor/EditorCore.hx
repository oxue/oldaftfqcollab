...
class EditorCore
{
	...
	public static function finish(e:Event):Void
	{
		...
		SimpleOut.writeLn("[v1.3] hi, I'm the editor, any error output, loading notices etc will come out here. Remember, if no error or debug information comes out and nothing is happening, I'm probably still working, be patient");
