...
class NewBufferWizard extends Panel
{
	...
	public function new()
	{
		...
		mapNameInput.value = "Untitled";
		mapWidthInput.value = "100";
		mapHeightInput.value = "100";
		tileSizeInput.value = "16";
	}
	...
	public function ok():Void
	{
		...
		var lr:LayersPanel = new LayersPanel(p.layers,p.dataLayers);
		EditorCore.currBuffer.binds.push(lr);
		p.onTopOfMe.push(lr);
		EditorCore.addPanel(lr);
