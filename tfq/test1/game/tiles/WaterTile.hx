...
class WaterTile extends Tile16
{
	...
	public function new() 
	{
		...
		animFrames.push(new Point(0, 8));
		animFrames.push(new Point(1, 8));
		animFrames.push(new Point(2, 8));
		animFrames.push(new Point(3, 8));
		waves = Global.tilesheet.toAnimation(animFrames);
		waves.options.looping = true;
		waves.options.tickDelay = 2;
		
		cache = Global.tilesheet.getTileBMD(4, 8);
	}
